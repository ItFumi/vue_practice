  ...
  <div>
    ...
    <div class="section">
      ...
      <p>
        ...
        <input type="checkbox" id="10" v-model="eventData.target">
        <label for="10">10代</label>
        <input type="checkbox" id="20" v-model="eventData.target">
        <label for="20">20代</label>
        <input type="checkbox" id="30" v-model="eventData.target">
